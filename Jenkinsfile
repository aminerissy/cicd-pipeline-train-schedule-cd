                        ...
                        publishers: [
                            sshPublisherDesc(
                                ...
                                transfers: [
                                    ...
                                    sshTransfer(execCommand: 'sudo /usr/bin/systemctl stop trainSchedule && rm -rf /opt/app/* && unzip /tmp/app.zip -d /opt/app && sudo /usr/bin/systemctl start trainSchedule')
                                ]
                            )
                        ]
                    )
