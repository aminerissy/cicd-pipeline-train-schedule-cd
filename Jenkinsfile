                            ...
                            sshPublisherDesc(
                                ...
                                transfers: [
                                    sshTransfer(
                                        ...
                                        removePrefix: 'dist/',
                                        remoteDirectory: '/tmp',
                                        execCommand: 'sudo systemctl stop trainSchedule && rm -rf /opt/app/* && sudo apt install unzip && sudo unzip /tmp/app.zip -d /opt/app && sudo systemctl start trainSchedule'  
                                    )
                                ]
                            )
                        ]
